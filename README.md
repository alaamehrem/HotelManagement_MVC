An hotel management system website that utilizes the MVC pattern. It employesthe generic repository pattern and SOLID principles to ensure the codebase’s maintainability and scalability.
